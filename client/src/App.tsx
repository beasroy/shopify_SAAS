              ...
              <Router>
                <TutorialManager>
                  ...
                  <Routes>
                    ...
                    <Route
                      path="/admetrics/:brandId"
                      element={<AnalyticsDashboard />}
                    />
                    <Route
                      path="/ecommerce-reports/:brandId"
                      element={<ReportsPage />}
                    />
                    <Route
                      path="/marketing-insights/:brandId"
                      element={<ExcelMetricsPage />}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="/segment-dashboard/:brandId"
                      element={<SegmentDashboard />}
                    />
                    <Route
                      path="/meta-reports/:brandId"
                      element={<FbReportPage />}
                    />
                    <Route
                      path="/google-reports/:brandId"
                      element={<GoogleAdsDashboard />}
                    />
                    <Route
                      path="/conversion-reports/:brandId"
                      element={<ConversionLens />}
                    />
                    ...
                    <Route
                      path="/brand-setup"
                      element={<BrandSetupDashboard />}
                    />
                    <Route path="/privacy-policy" element={<PrivacyPolicy />} />
                    <Route
                      path="/meta-campaigns/:brandId"
                      element={<CampaignPage />}
                    />
                    <Route
                      path="/meta-interest/:brandId"
                      element={<InterestPage />}
                    />
                    <Route
                      path="/pricing_callback"
                      element={<PricingCallback />}
                    />
                  </Routes>
                </TutorialManager>
              </Router>
