  ...
  useEffect(() => {
    const handleOauthCallback = async () => {
      try {
        ...
        const googleAnalyticsRefreshToken = queryParams.get(
          ...
          try {
            ...
            if (response.data.success) {
              ...
              if (type === "zohoToken") {
                ...
                navigate("/dashboard", { state: platform });
              }
              return true;
            } else {
        ...
        if (userId && appToken) {
          ...
          const getUser = await axios.get(
            `${baseURL}/api/users/getuser/${userId}?token=${appToken}`
          );
