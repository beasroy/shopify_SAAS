...
export function DatePickerWithRange({
  ...
  const presets = useMemo(
    () => [
      ...
      {
        label: "Maximum (37 mon)",
        fn: () => setPresetRange(subMonths(dates.today, 37), dates.today),
      },
    ],
    [dates, setPresetRange],
  );
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <span className="truncate">{formatDateRange(tempDate)}</span>
        </Button>
      </PopoverTrigger>

      <PopoverContent
        align="start"
        className="w-[calc(100vw-1rem)] max-h-[85vh] sm:w-auto max-w-[650px] p-0 overflow-hidden"
      >
        <div className="max-h-[80vh] overflow-y-auto">
          <div className="flex flex-col md:flex-row">
            <div
              className="border-b md:border-b-0 md:border-r p-3 w-full md:w-[150px] overflow-y-auto bg-gradient-to-b from-muted/50 to-muted/10"
            ...
            <div className="p-3 flex-grow min-w-0">
              ...
              {/* <div className="border rounded-lg p-2 bg-background/80 shadow-sm overflow-x-auto"> */}
              <div className="border rounded-lg p-2 bg-background/80 shadow-sm">
                <Calendar
                  initialFocus
                  mode="range"
        ...
        <div className="border-t p-2 flex justify-end gap-2 bg-muted/10 sticky bottom-0">
          <Button
            variant="outline"
            size="sm"
            onClick={clearDateRange}
