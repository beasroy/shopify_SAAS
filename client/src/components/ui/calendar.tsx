  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground rounded-md flex-1 font-normal text-[0.6rem] text-center",
        row: "flex w-full mt-2",
        cell: cn(
          "relative p-0 text-center text-[0.7rem] flex-1 focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
            ? "[&:has(>.day-range-end)]:rounded-r-md [&:has(>.day-range-start)]:rounded-l-md first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md"
            : "[&:has([aria-selected])]:rounded-md",
        ),
        day: cn(
          ...
          "h-8 w-full p-0 font-normal aria-selected:opacity-100 text-[0.7rem]"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
