export const privacyPolicySections = [
    ...
    },
    {
      ...
      content: [
        "Our application accesses and processes the following Google user data:",
        [
          ...
          "User Profile Information: We collect user email and profile data."
        ]
      ]
    },
    {
    ...
    {
      title: "8. Compliance with Google API Services Policy",
      content: [
