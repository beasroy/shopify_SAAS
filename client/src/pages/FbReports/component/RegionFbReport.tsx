...
const RegionFbReport: React.FC<CityBasedReportsProps> = ({ dateRange: propDateRange }) => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const response = await axiosInstance.post(`/api/fbReport/region/${brandId}`, {
        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <div className="flex items-center gap-3">
                    <FacebookLogo />
                    <div>
                        <h2 className="text-xl font-semibold tracking-tight">Region Insights</h2>
                    </div>
                </div>
