...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "justify-start min-[578px]:justify-self-center flex flex-col lg:border-r  py-10 relative group/feature dark:border-neutral-800",
...
const PlatformFeatures = [
  {
    ...
    description:
      "View all your marketing data in one place with customizable widgets",
  ...
  },
  {
    ...
    description:
      "Monitor business performance across platforms and time periods",
    icon: <LineChart className="h-8 w-8 text-primary" />,
  },
  {
    title: "Demographic Analysis",
    description:
      "Track conversions based on location, demographics, brands, and products",
  ...
  },
  {
    ...
    description:
      "Group campaigns by category to analyze performance at a glance",
...
function Features() {
  return (
    <section
      id="features"
      className="w-full py-12 md:py-12 lg:py-20 bg-slate-100 px-4"
    >
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-5">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-muted-foreground md:text-lg">
              Track performance, scale campaigns, and maximize ROI—all with
              ease.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 min-[578px]:grid-cols-2 lg:grid-cols-4  relative z-10 pt-6 max-w-7xl mx-auto">
