  ...
  return (
    ...
    >
      <div className="glass-card rounded-2xl p-5 w-full max-w-[480px] mx-auto">
              ...
              <div key={bar.label} className="flex-1 flex flex-col items-center gap-1.5">
                <div className="w-full flex items-end justify-center" style={{ height: '80px' }}>
                  <motion.div
                    ...
                    style={{ backgroundColor: bar.color, maxWidth: '40px' }}
                    initial={{ height: 0 }}
        ...
        <div className="border-t border-slate-100 pt-4">
          ...
          <svg viewBox="0 0 200 40" className="w-full h-10" preserveAspectRatio="none">
            ...
            <motion.path
              d="M0,32 C20,28 40,18 60,20 C80,22 100,10 120,8 C140,6 160,14 180,10 L200,8"
              fill="none"
              stroke="#6366f1"
              strokeWidth="2"
              strokeLinecap="round"
            ...
            />
            <motion.path
              d="M0,32 C20,28 40,18 60,20 C80,22 100,10 120,8 C140,6 160,14 180,10 L200,8 L200,40 L0,40 Z"
              fill="url(#lineGrad)"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <motion.div
        ...
        className="absolute -top-3 -right-3 bg-white border border-slate-200 rounded-xl px-3 py-2 shadow-lg text-xs font-semibold text-indigo-600 flex items-center gap-1.5"
      >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
        ...
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.div variants={item} className="flex flex-wrap items-center gap-3">
            <Link
              to="/login"
              className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors shadow-md shadow-indigo-200"
            >
              Get Demo <ArrowRight size={16} />
            </Link>
            <Link
              to="/login"
              className="inline-flex items-center gap-2 border border-slate-200 hover:border-slate-300 text-slate-700 font-semibold px-6 py-3 rounded-xl transition-colors bg-white"
            >
              Sign In
            </Link>
          </motion.div>
