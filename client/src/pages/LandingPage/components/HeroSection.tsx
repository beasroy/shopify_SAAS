...
function HeroSection() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden gradient-bg">
      ...
      <div className="mx-auto max-w-4xl lg:max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="pb-14 pt-20">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
            <div className="flex flex-col justify-center items-center lg:items-start">
              ...
              <h1 className="text-center text-4xl font-bold tracking-tight text-white lg:text-left lg:text-5xl">
                <span className="block mb-2">
                  {/* All Your Marketing Data, One Place. */}
                  All marketing data at one place.
                </span>
              </h1>

              <p className="mt-6 text-center text-lg text-slate-200 lg:text-left">
                Connect Shopify, Meta, Google Ads, and GA4 in one dashboard.
                Track performance, analyze conversions, and get automated email
                reports.
              </p>
              ...
              <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                ...
                {/* <Button
                  size="lg"
                  variant="outline"
                  className="w-full border-slate-800 text-black hover:bg-blue-100 sm:w-auto"
                >
                  View Demo
                </Button> */}
              </div>
            ...
            <div className="relative">
              <div className="relative mx-auto max-w-3xl lg:max-w-full rounded-2xl border border-slate-800 bg-[#0A0A1B] p-4 mt-5 lg:mt-0">
                {/* Window Controls */}
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    {/* <Button
                      variant="outline"
                      size="sm"
                      className="border-slate-800 cursor-auto"
                    >
                      Export
                    </Button> */}
                  </div>
