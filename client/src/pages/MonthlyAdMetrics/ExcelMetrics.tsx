...
export const ExcelMetricsPage: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <CollapsibleSidebar />
      <div className="flex-1 h-screen overflow-auto flex items-center justify-center p-4">
        <div className="max-w-2xl w-full space-y-4">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <p className="text-2xl font-bold text-gray-800 mb-2">We're making improvements and will be back online soon.</p>
            <p className="text-sm text-gray-500">We apologize for the inconvenience. Please check back later.</p>
          </div>
        </div>
      </div>
      <HelpDeskModal />
