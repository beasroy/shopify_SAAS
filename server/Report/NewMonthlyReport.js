...
//         const isCancelled = order.cancelled_at && order.cancelled_at !== null;
...
//                 // Only include taxes if the order is not cancelled
//                 if (!isCancelled && item.tax_lines && Array.isArray(item.tax_lines)) {
...
//         // If order is cancelled, treat the entire amount as refund
//         if (isCancelled) {
//             acc[orderDate].refundAmount += totalPrice;
//             acc[orderDate].cancelledOrderCount++;
//             console.log(`Order ${order.id} is cancelled - adding ${totalPrice} to refunds for ${orderDate}`);
//         } else {
...
//         if (isCancelled) {
//             console.log(`Order ${order.id} is cancelled - excluded from sales calculation`);
//         }
//     }
// }
...
//         // Declare orders variable outside the try block
//         let orders = [];
        
//         // Fetch all orders from the date range
//         try {
//             orders = await fetchAllOrdersChunked(shopify, originalStartDate, originalEndDate, storeTimezone, isTestOrder);
//             console.log('✅ Orders fetched successfully:', orders.length);
            
//             // Process orders for sales data and refunds
...
//             console.log(`Processing refund ${refund.refundId} for date ${refundDate}: totalReturn=${refund.totalReturn}`);
//             return acc;
//         }, {});
