    ...
    try {
        ...
        const locationGroupStage = {
            $group: {
                ...
                originalLocation: { $first: isRegionDimension ? "$state" : "$city" },
                originalCity: { $first: "$city" },
                originalState: { $first: "$state" },
                originalCountry: { $first: { $ifNull: ["$country", "unknown"] } },


                metroStatus: { $first: { $ifNull: ["$cityMeta.metroStatus", null] } },
                region: { $first: { $ifNull: ["$cityMeta.region", null] } },
                tier: { $first: { $ifNull: ["$cityMeta.tier", null] } },
                isCoastal: { $first: { $ifNull: ["$cityMeta.isCoastal", null] } },


                isClassified: { $first: { $gt: ["$cityMeta", null] } },
