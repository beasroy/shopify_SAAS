...
import { addBrands, getBrandbyId, getBrands, getBrandNames, updateBrands, filterBrands, getCurrency, deleteBrand, deletePlatformIntegration, getBrandDomain } from '../controller/brand.js';
...
router.get('/domain/:brandId',verifyAuth, getBrandDomain);
